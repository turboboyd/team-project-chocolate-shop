...
const modalEl = document.querySelector('.modal.modal-review');
const modalHero = document.querySelector('.modal-feedback');
// выбираем  кнопку submit модалки buynow
const submitButton = document.querySelectorAll('.modal-review-submit');

// выбираем форму
const form = document.forms['reviews-form'];
